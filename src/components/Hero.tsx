          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-300">Được tin tưởng bởi hơn 10.000 khách hàng</span>
              </div>
              ...
              <p className="text-xl text-slate-300 max-w-lg">
                Tìm mọi thứ bạn cần tại một nơi. Sản phẩm chất lượng, giá cả không thể cạnh tranh, 
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              ...
              <div className="text-center">
                ...
                <div className="text-slate-400">Hỗ trợ</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-amber-400">Miễn phí</div>
                <div className="text-slate-400">Vận chuyển</div>
              </div>
            </div>
          </div>
